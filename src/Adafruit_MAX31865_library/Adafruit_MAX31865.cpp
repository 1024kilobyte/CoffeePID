...
*/
/**************************************************************************/
float Adafruit_MAX31865::temperature(float RTDnominal, float refResistor) { //read RTD in 1-Shot mode
  return temperature(RTDnominal, refResistor, readRTD());
}
float Adafruit_MAX31865::temperature_nowait(float RTDnominal, float refResistor) { //read RTD in automatic conversion mode (DRDY should be low)
  return temperature(RTDnominal, refResistor, readRegister16(MAX31865_RTDMSB_REG)>>1);
}

float Adafruit_MAX31865::temperature(float RTDnominal, float refResistor, float Rt) {
